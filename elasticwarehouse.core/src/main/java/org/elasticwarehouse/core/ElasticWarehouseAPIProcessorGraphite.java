...
public class ElasticWarehouseAPIProcessorGraphite extends ElasticWarehouseAPIProcessor {
	...
	public ElasticWarehouseAPIProcessorGraphite(ElasticWarehouseConf conf, ElasticSearchAccessor elasticSearchAccessor) throws MalformedObjectNameException, IntrospectionException, InstanceNotFoundException, NullPointerException, ReflectionException, IOException, ParseException, InterruptedException
	{
		conf_  = conf;
